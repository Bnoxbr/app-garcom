                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center border-t border-gray-100 pt-3">
                      ...
                      <button
                        ...
                        className="bg-gray-800 text-white px-4 py-2 rounded-lg text-sm font-medium cursor-pointer"
                      >
                        Dar Lance
                      </button>
                    </div>
          ...
          <div className="bg-white rounded-lg w-full max-w-md">
            ...
            <div className="p-4">
              ...
              <button
                ...
                className="w-full bg-gray-800 text-white py-3 rounded-lg font-medium cursor-pointer"
              >
                Confirmar Lance
              </button>
            </div>
