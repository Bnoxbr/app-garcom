...
const MainLayout: React.FC = () => {
    ...
    const logoUrl = "https://rtcafnmyuybhxkcxkrzz.supabase.co/storage/v1/object/public/client-logos/StafferWork.png"; 
        ...
        <div className="relative min-h-screen bg-gray-100 pb-32">
                    ...
                    <div>
                        {user ? (
                            <button onClick={handleProfileClick} className="flex items-center space-x-2">
                                {/* TEXTO: Fica branco no topo e [mr-dark-blue] -> [sw-blue-primary] quando rolado */}
                                ...
                                {/* BORDA: Borda [mr-dark-blue] -> [sw-blue-primary] quando rolado */}
                                <img 
            ...
            <div className="fixed bottom-4 left-4 right-4 bg-white rounded-2xl shadow-lg z-20 border border-gray-100">
                <div className="max-w-4xl mx-auto grid grid-cols-5 h-16">
                    {/* Item 'Início' - ATIVO: text-[mr-highlight] -> text-[sw-yellow-accent] */}
